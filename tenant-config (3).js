...
(function (global) {
  ...
  var TENANTS = {
    ...
    "default": {
      ...
      /* ── Sector-terminologie ────────────────────────────────────
         Objectmap van "HTML-term" → "vervangende term".
         Leeg = de woorden in de HTML blijven staan (AV-baseline).
         Niet-AV tenants overschrijven dit met sectorjargon, bv.:
           { "Vergaderzaal": "Installatie", "zalen": "installaties", … }
         Of laad een kant-en-klaar pakket via TC.applySectorPreset().
  ...
  var SECTOR_PRESETS = {
    ...
    /* AV / vergaderzalen — noop, dit is de HTML-baseline */
    av: {},
    ...
    interior: {
      ...
      "Vergaderzaal":                 "Ruimte",
      "vergaderzaal":                 "ruimte",
      "Zalen & producten":            "Ruimtes & meubelen",
      "zalen & producten":            "ruimtes & meubelen",
      "Zalen":                        "Ruimtes",
      "zalen":                        "ruimtes",
      "Zaal":                         "Ruimte",
  ...
  var TC = {
    ...
    /* Pas een sectorpreset toe op de actieve tenant. Handmatige terminology-
       ...
       Roep hierna TC.apply() aan — of TC.save() als je ook wilt bewaren. */
