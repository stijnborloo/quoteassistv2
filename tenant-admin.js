...
(function (global) {
  ...
  function injectStyles() {
    ...
    style.textContent = [
      ...
      ".tc-header h2:before{content:'⚙';display:inline-flex;align-items:center;justify-content:center;width:28px;height:28px;margin-right:9px;border-radius:7px;background:#714b67;color:#fff;font-size:13px;vertical-align:-7px}",
      ...
      ".tc-tenant-bar select:focus{border-color:#714b67;box-shadow:0 0 0 2px rgba(113,75,103,.12)}",
      ...
      ".tc-nav-item.active{background:#e8e1e6;color:#714b67;font-weight:600}",
      ".tc-nav-item.active:before{content:'';position:absolute;left:0;top:5px;bottom:5px;width:3px;border-radius:0 3px 3px 0;background:#714b67}",
      ...
      ".tc-input:focus{outline:0;border-color:#714b67;box-shadow:0 0 0 2px rgba(113,75,103,.12)}",
      ...
      ".tc-range-wrap input[type=range]{flex:1;accent-color:#714b67;cursor:pointer;height:4px}",
      ...
      ".tc-toggle input:checked+.tc-toggle-track{background:#714b67}",
      ...
      ".tc-preset:hover{border-color:#714b67;color:#714b67;background:#faf7f9}",
      ".tc-preset.active{background:#714b67;color:#fff;border-color:#714b67}",
      ...
      ".tc-btn-save{background:#714b67;color:#fff;border:1px solid #714b67}",
      ".tc-btn-save:hover{background:#5d3d55;border-color:#5d3d55}",
      ...
      "@media(max-width:700px){",
        ...
        ".tc-tab.active{color:#714b67;font-weight:600;border-bottom-color:#714b67}",
