...
(function (global) {
  ...
  var TENANTS = {
    ...
    "default": {
      slug:             "default",
      companyName:      "VisiOffer",
      companyNameShort: "VisiOffer",
      primaryColor:     "#6d3cf5",
      coverColor:       "",          /* leeg → volgt primaryColor */
      logoBackdrop:     false,       /* wit vlak achter cover-logo */
      logoSize:         28,          /* hoogte logo in de app-balk (px) */
      coverLogoSize:    38,          /* hoogte logo op de coverpagina (px) */
      ...
      pwaName:          "VisiOffer — Offerte Studio",
      pwaShortName:     "VisiOffer",
      logo:             '<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 340 56"><defs><linearGradient id="vo-gr" x1="0" y1="0" x2="1" y2="0"><stop offset="0%" stop-color="#6d3cf5"/><stop offset="100%" stop-color="#8b5cf6"/></linearGradient></defs><text font-family="Inter,Arial,Helvetica,sans-serif" font-weight="900" font-size="52" letter-spacing="-1.5" y="44"><tspan fill="#1e2340">visi</tspan><tspan fill="url(#vo-gr)">offer</tspan></text></svg>',
      logoWhite:        '<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 340 56"><text font-family="Inter,Arial,Helvetica,sans-serif" font-weight="900" font-size="52" letter-spacing="-1.5" fill="#ffffff" y="44">visioffer</text></svg>',
